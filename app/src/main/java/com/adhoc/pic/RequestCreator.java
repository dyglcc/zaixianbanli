...
import static com.adhoc.pic.PicassoDrawable.setBitmap;
import static com.adhoc.pic.PicassoDrawable.setPlaceholder;
import static com.adhoc.pic.Utils.OWNER_MAIN;
import static com.adhoc.pic.Utils.VERB_CHANGED;
import static com.adhoc.pic.Utils.VERB_COMPLETED;
import static com.adhoc.pic.Utils.VERB_CREATED;
import static com.adhoc.pic.Utils.checkMain;
import static com.adhoc.pic.Utils.checkNotMain;
import static com.adhoc.pic.Utils.createKey;
import static com.adhoc.pic.Utils.log;
...
//  }
      ...
      if (MemoryPolicy.shouldReadFromMemoryCache(memoryPolicy)) {
        ...
        if (bitmap != null) {
          if (picasso.loggingEnabled) {
            log(OWNER_MAIN, VERB_COMPLETED, request.plainId(), "from " + Picasso.LoadedFrom.MEMORY);
          }
          if (callback != null) {
            callback.onSuccess();
          }
  ...
  public void into(Target target) {
    ...
    if (MemoryPolicy.shouldReadFromMemoryCache(memoryPolicy)) {
      ...
      if (bitmap != null) {
        picasso.cancelRequest(target);
        T.i("image picasso onBitmapLoaded");
