...
package com.adhoc.http.internal.http;

import com.adhoc.http.Connection;
import com.adhoc.http.Request;
import com.adhoc.http.Address;
import com.adhoc.http.ConnectionPool;
import com.adhoc.http.Headers;
import com.adhoc.http.HttpUrl;
import com.adhoc.http.Interceptor;
import com.adhoc.http.MediaType;
import com.adhoc.http.OkHttpClient;
import com.adhoc.http.Protocol;
import com.adhoc.http.Response;
import com.adhoc.http.ResponseBody;
import com.adhoc.http.Route;
import com.adhoc.http.internal.InternalCache;
import com.adhoc.http.internal.Util;
import com.adhoc.http.internal.Version;
import com.adhoc.http.CertificatePinner;
import com.adhoc.http.internal.Internal;
...
import com.adhoc.io.GzipSource;
...
import static com.adhoc.http.internal.Util.closeQuietly;
...
//            return  null;
    ...
    public Connection close() {
        ...
        if (userResponse == null) {
            if (connection != null)
                Util.closeQuietly(connection.getSocket()); // TODO: does this break SPDY?
            connection = null;
            return null;
        }
