...
public final class WebSocketReader {
  public interface FrameCallback {
    void onMessage(BufferedSource source, WebSocket.PayloadType type) throws IOException;
  ...
  private void readHeader() throws IOException {
    ...
    if (isControlFrame && frameLength > WebSocketProtocol.PAYLOAD_MAX) {
      throw new ProtocolException("Control frame must be less than " + WebSocketProtocol.PAYLOAD_MAX + "B.");
    }
