...
public class UTF8 {
    ...
    public static String encode(String string) throws com.adhoc.nkzawa.utf8.UTF8Exception {
    ...
    public static String decode(String byteString) throws com.adhoc.nkzawa.utf8.UTF8Exception {
    ...
    private static String encodeCodePoint(int codePoint) throws com.adhoc.nkzawa.utf8.UTF8Exception {
    ...
    private static int decodeSymbol() throws com.adhoc.nkzawa.utf8.UTF8Exception {
        int byte1;
        int byte2;
        int byte3;
        int byte4;
        ...
        if (byteIndex > byteCount) {
            throw new com.adhoc.nkzawa.utf8.UTF8Exception("Invalid byte index");
        }
        ...
        if ((byte1 & 0xE0) == 0xC0) {
            ...
            if (codePoint >= 0x80) {
                ...
                throw new com.adhoc.nkzawa.utf8.UTF8Exception("Invalid continuation byte");
            }
        }
    ...
    private static int readContinuationByte() throws com.adhoc.nkzawa.utf8.UTF8Exception {
        if (byteIndex >= byteCount) {
            throw new com.adhoc.nkzawa.utf8.UTF8Exception("Invalid byte index");
        }
    ...
    private static void checkScalarValue(int codePoint) throws com.adhoc.nkzawa.utf8.UTF8Exception {
        if (codePoint >= 0xD800 && codePoint <= 0xDFFF) {
            throw new com.adhoc.nkzawa.utf8.UTF8Exception(
