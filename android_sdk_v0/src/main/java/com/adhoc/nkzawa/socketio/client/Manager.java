package com.adhoc.nkzawa.socketio.client;

import com.adhoc.nkzawa.backo.Backoff;
import com.adhoc.nkzawa.emitter.Emitter;
import com.adhoc.nkzawa.socketio.parser.Packet;
import com.adhoc.nkzawa.socketio.parser.Parser;
...
public class Manager extends Emitter {
    ...
    /*package*/ com.adhoc.nkzawa.engineio.client.Socket engine;
    ...
    public Manager open(final OpenCallback fn) {
        EventThread.exec(new Runnable() {
            ...
            public void run() {
                ...
                final com.adhoc.nkzawa.engineio.client.Socket socket = Manager.this.engine;
    ...
    private void onopen() {
        ...
        final com.adhoc.nkzawa.engineio.client.Socket socket = this.engine;
    ...
    private static class Engine extends com.adhoc.nkzawa.engineio.client.Socket {
    ...
    public static class Options extends com.adhoc.nkzawa.engineio.client.Socket.Options {
