package com.adhoc.nkzawa.engineio.client.transports;


import com.adhoc.nkzawa.engineio.client.Transport;
import com.adhoc.nkzawa.engineio.parser.Packet;
import com.adhoc.nkzawa.engineio.parser.Parser;
import com.adhoc.nkzawa.parseqs.ParseQS;
import com.adhoc.nkzawa.thread.EventThread;
import com.adhoc.http.OkHttpClient;
import com.adhoc.http.Request;
import com.adhoc.http.Response;
import com.adhoc.http.ws.WebSocket.PayloadType;
import com.adhoc.http.ws.WebSocketCall;
import com.adhoc.http.ws.WebSocketListener;
import com.adhoc.nkzawa.utf8.UTF8Exception;
...
import static com.adhoc.http.ws.WebSocket.PayloadType.BINARY;
import static com.adhoc.http.ws.WebSocket.PayloadType.TEXT;
...
public class WebSocket extends Transport {
    ...
    private com.adhoc.http.ws.WebSocket ws;
    ...
    protected void doOpen() {
        ...
        wsCall.enqueue(new WebSocketListener() {
            @Override
            public void onOpen(com.adhoc.http.ws.WebSocket webSocket, Response response) {
                ws = webSocket;
